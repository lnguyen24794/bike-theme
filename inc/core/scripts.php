...
function bike_theme_scripts()
{
    ...
    wp_enqueue_style('bike-theme-swiper', get_template_directory_uri() . '/assets/css/swiper-bundle.min.css', array(), BIKE_THEME_VERSION);
    wp_enqueue_style('bike-theme-justifiedGallery', get_template_directory_uri() . '/assets/css/justifiedGallery.min.css', array(), BIKE_THEME_VERSION);
    ...
    wp_enqueue_script('bike-theme-swiper', get_template_directory_uri() . '/assets/js/swiper-bundle.min.js', array('jquery'), BIKE_THEME_VERSION, true);
    wp_enqueue_script('bike-theme-justifiedGallery', get_template_directory_uri() . '/assets/js/justifiedGallery.min.js', array('jquery'), BIKE_THEME_VERSION, true);
