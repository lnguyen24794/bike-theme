            ...
            <div class="col-12">
                <div class="row gy-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <p><i class="fab fa-whatsapp text-primary me-2"></i><a href="https://api.whatsapp.com/send/?phone=<?php echo esc_attr(bike_theme_get_option('contact_phone', '84985455727')); ?>&text&type=phone_number&app_absent=0"><?php echo esc_html(bike_theme_get_option('contact_whatsapp', '+84 985 455 727')); ?></a></p>
                    </div>
                </div>
            </div>
